import { ScrollText, Trash2, Download, Filter, Check } from "lucide-react";
                ...
                <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-xs">{getTranslation("admin.logs.description")}</CardDescription>
                        </div>
                    </div>
                        ...
                        <Popover open={filterOpen}>
                            <PopoverTrigger asChild>
                                ...
                                >
                                    ...
                                    {levelFilter ?? getTranslation("admin.logs.filter_all")}
                                </Button>
                            </PopoverTrigger>
